        ...
        replaceToDataURL: (options) => {
            ...
            HTMLCanvasElement.prototype.toDataURL = function (type, encoderOptions) {
                ...
                if (typeof type === 'undefined' || type === 'image/png') {
                    ...
                    return new Base64Writer().bytesToBase64('data:image/png;base64,', new PngWriter().write(ctx.getImageData(0, 0, me.width, me.height), Object.assign({}, options, { level: level })));
                }
