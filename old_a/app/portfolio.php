  ...
  <div class="portfolio_intro row-fluid">
    <div class="portfolio_intro col-xs-12">
      <div class="portfolio_intro_container">
        <div class="portfolio_intro_container_container">
          <h1>KLIAMTOR</h1>
...
<section class="portfolio_text container-fluid">
  <div class="portfolio_text row-fluid">
    <div class="portfolio_text col-xs-12">
      <div class="portfolio_text_container col-xs-8 col-xs-offset-2">
        <h1>Climat specialist</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscin elit.
          In auctor quam metus, ut condimentum enim maximusin.
          Aenean mi magna, fermentum at bibendum id
          <a href="http://Klimator.se" target="_blank">Go directly to the website</a>
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="portfolio_text row-fluid">
    <div class="portfolio_text col-xs-12">
      <div class="portfolio_text_container col-xs-8 col-xs-offset-2">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscin elit.
          In auctor quam metus, ut condimentum enim maximusin.
          Aenean mi magna, fermentum at bibendum id</p>
      </div>
    </div>
  </div>
</section>
...
<section class="portfolio_text container-fluid">
  <div class="portfolio_text row-fluid">
    <div class="portfolio_text col-xs-12">
      <div class="portfolio_text_container col-xs-8 col-xs-offset-2">
        <h1>Tablet and mobil</h1>
        <p>On desktop as on tablet and smartphone,
          content reading is easy thanks to the serif /
          sans serif font combination and type sizes.
          On mobile, pictures are minimized to enable a quick loading and a smooth navigation.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="portfolio_info row-fluid">
    <div class="portfolio_info col-xs-12">
      <div class="portfolio_info_container">
        <h1>Klimator in brief</h1>
        <div class="col-md-3 col-sm-6 col-xs-12 portfolio_info_info">
          <h2>Lines of code</h2>
          <hr>
