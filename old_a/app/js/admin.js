...
// when a new element is cloned, the listener is not cloned and therfor a listener
// has to be applied to all the new elements again
...
// this is run everytime an image is selected in an inputtag.
// This will load the selected image into a temporary img-tag
// and the data will be fetch from the temporary img-tag when the form is sent
...
//compress uploaded files to the database
